...
hist(StepsPerDay$mean, main="", xlab="Total number of steps taken each day")
```
...
# Histogram.
StepsPerDay.FilledNAs <- ddply(activity.FilledNAs, .(date), summarize, mean = mean(steps, na.rm = TRUE))
hist(StepsPerDay.FilledNAs$mean, main="", xlab="Total number of steps taken each day")
```
